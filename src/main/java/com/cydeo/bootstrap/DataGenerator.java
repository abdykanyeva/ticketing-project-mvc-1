...
public class DataGenerator implements CommandLineRunner {
    ...
    @Override
    public void run(String... args) throws Exception { // BREAK TILL 12:10
        ...
        // create users and put int the db
        ...
        TaskDTO task1 = new TaskDTO(1L, project1, user8, "Controller", LocalDate.now().minusDays(4), "Request Mapping", Status.IN_PROGRESS);
        TaskDTO task2 = new TaskDTO(2L, project3, user3, "Configuration", LocalDate.now().minusDays(12), "Database Connection", Status.COMPLETE);
        TaskDTO task3 = new TaskDTO(3L, project3, user6, "Mapping", LocalDate.now().minusDays(8), "One-To-Many", Status.COMPLETE);
        TaskDTO task4 = new TaskDTO(4L, project2, user7, "Dependency Injection", LocalDate.now().minusDays(20), "Autowired", Status.IN_PROGRESS);
